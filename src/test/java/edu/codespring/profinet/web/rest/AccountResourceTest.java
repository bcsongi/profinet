...
import edu.codespring.profinet.domain.Authority;
import edu.codespring.profinet.domain.User;
import edu.codespring.profinet.repository.AuthorityRepository;
...
import edu.codespring.profinet.security.AuthoritiesConstants;
import edu.codespring.profinet.service.MailService;
...
public class AccountResourceTest {
    ...
    public void setup() {
        ...
        ReflectionTestUtils.setField(accountResource, "userSearchRepository", userSearchRepository);
        ...
        ReflectionTestUtils.setField(accountUserMockResource, "userSearchRepository", userSearchRepository);
