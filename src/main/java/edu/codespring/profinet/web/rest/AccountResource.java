...
import edu.codespring.profinet.security.SecurityUtils;
...
public class AccountResource {
    ...
    public ResponseEntity<?> registerAccount(@Valid @RequestBody UserDTO userDTO, HttpServletRequest request) {
    	...
    	if (userSearchRepository.findOneByLogin(userDTO.getLogin())==null) userSearchRepository.save(userMapper.userDTOToUser(userDTO));
