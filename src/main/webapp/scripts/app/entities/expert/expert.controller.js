...
angular.module('profinetApp')
    .controller('ExpertController', function ($scope, Expert, ExpertSearch, ParseLinks) {
        $scope.experts = [];
        $scope.page = 1;
        ...
        $scope.clear = function () {
            $scope.expert = {expertuser: null, timetable: null, phoneNumber: null, lastActive: null, latitude: null, longitude: null, active: null, id: null};
        };
    });
